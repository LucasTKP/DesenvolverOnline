...
function OurNumbers() {
    return (
        <section className='px-[10%] max-2xl:px-[9%] max-xl:px-[8%] max-lg:px-[6%] max-md:px-[4%] max-sm:px-[3%] bg-[#88DCC0] mt-[50px] py-[50px] max-xl:py-[40px] max-lg:py-[30px] max-md:py-[20px]'>
            <p className='font-medium text-[34px] max-2xl:text-[32px] max-xl:text-[30px] max-lg:text-[27px] max-md:text-[24px] max-sm:text-[22px] max-lsm:text-[19px] text-center'>Nossos Números falam <br /> por si mesmo</p>
